...
# from models.modblock import Encodmod
...
def parse_args():
    ...
    parser.add_argument('--data_folder', type=str, default='/kaggle/input/icbhi-data/data')
    ...
    parser.add_argument('--test_fold', type=str, default='0', choices=['official', '0', '1', '2', '3', '4'],
...
def set_loader(args):
    ...
    val_loader = torch.utils.data.DataLoader(val_dataset, batch_size=args.batch_size, shuffle=False,
                                             num_workers=args.num_workers, drop_last=True ,pin_memory=True, sampler=None)
...
#     modulate = torch.nn.DataParallel(modulate)
...
#     modulate.train()
    ...
    for idx, (images, labels) in enumerate(train_loader):
        ...
        # images_1 = images_1.squeeze(1)
        # images_1 = images_1.permute(0,2,1)
        ...
        with torch.cuda.amp.autocast():
          ...
          # print(f'image shape just before {images.shape}')
          # print(images_1.shape, images_2.shapeimage)
          # images2 = images[:,:,:792]
          # images2 = images2.cuda()
          features  = model(images)
#           mod_images  = mod_images.permute(0,2,1).cuda()
          # out_train,hid_train_2 = mogrify2(hid_train,hid)
        
          features = features.permute(1,2,0)
          
          output = classifier(features)  ## 32,798,128
...
#                 modulate = update_moving_average(args.ma_beta, modulate, ma_ckpt[1])
